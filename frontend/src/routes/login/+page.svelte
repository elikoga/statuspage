	...
	<div class="w-full max-w-sm">
		...
		{#if data.oidcEnabled}
			...
			<details class="group">
				...
				>
					...
					<button
						type="submit"
						class="w-full bg-gray-600 hover:bg-gray-700 text-white rounded-lg px-4 py-2 text-sm font-medium transition-colors"
					>
						Sign in
					</button>
				</form>
		...
		{:else}
			...
			>
				...
				<button
					type="submit"
					class="w-full bg-blue-600 hover:bg-blue-700 text-white rounded-lg px-4 py-2 text-sm font-medium transition-colors"
				>
					Sign in
				</button>
			</form>
