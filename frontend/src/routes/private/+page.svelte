...
<svelte:head>
	<title>Private Status — Status Page</title>
</svelte:head>
	...
	<header class="bg-white shadow-sm">
		<div class="mx-auto max-w-3xl px-4 py-6 flex items-center justify-between">
			<div>
				...
				<span class="inline-block mt-1 text-xs font-medium px-2 py-0.5 rounded bg-gray-100 text-gray-600">Private view — includes hidden services</span>
			</div>
